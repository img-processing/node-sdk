...
Use the Img Processing MCP Server to enable AI assistants to interact with this API, allowing them to explore endpoints, make test requests, and use documentation to help integrate this SDK into your application.

[![Add to Cursor](https://cursor.com/deeplink/mcp-install-dark.svg)](https://cursor.com/en-US/install-mcp?name=img-processing-mcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsImltZy1wcm9jZXNzaW5nLW1jcCJdfQ)
[![Install in VS Code](https://img.shields.io/badge/_-Add_to_VS_Code-blue?style=for-the-badge&logo=data:image/svg%2bxml;base64,)](https://vscode.stainless.com/mcp/%7B%22name%22%3A%22img-processing-mcp%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22img-processing-mcp%22%5D%7D)
...
await client.images.upload({ image: new File(['my bytes'], 'file'), name: 'example-image' });
...
1. Via the `IMG_PROCESSING_LOG` environment variable
...
const client = new ImgProcessing({
  logger: logger.child({ name: 'ImgProcessing' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/img-processing/node-sdk/issues) with questions, bugs, or suggestions.
