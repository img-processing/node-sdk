...
const prompt = `Runs JavaScript code to interact with the Img Processing API.
    ...
    const res = await fetch(codeModeEndpoint, {
      ...
      headers: {
        ...
        client_envs: JSON.stringify({
          IMG_PROCESSING_API_KEY: readEnvOrError('IMG_PROCESSING_API_KEY'),
          IMG_PROCESSING_BASE_URL: readEnv('IMG_PROCESSING_BASE_URL'),
        }),
      },
      body: JSON.stringify({
        project_name: 'img-processing',
        code,
        client_opts: {},
