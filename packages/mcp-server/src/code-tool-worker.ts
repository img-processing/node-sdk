...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: ImgProcessing)`
    : `const run: (${functionSource.client}: ImgProcessing) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    'client.images.addWatermark',
    'client.images.blur',
    'client.images.classify',
    'client.images.convert',
    'client.images.createFromURL',
    'client.images.crop',
    'client.images.delete',
    'client.images.download',
    'client.images.extractFormattedText',
    'client.images.imagine',
    'client.images.list',
    'client.images.mirror',
    'client.images.modulate',
    'client.images.publish',
    'client.images.removeBackground',
    'client.images.resize',
    'client.images.retrieve',
    'client.images.rotate',
    'client.images.unpublish',
    'client.images.upload',
    'client.images.visualize',
  ],
